                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($outgoingGoods as $outgoing)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <div class="font-semibold">{{ $outgoing->recipient_name }}</div>
                                    @if ($outgoing->department)
                                        <div class="text-xs text-gray-500">{{ $outgoing->department }}</div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    {{ Str::limit($outgoing->purpose ?? '-', 30) }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @elseif($outgoing->status == 'approved')
                                        <span
