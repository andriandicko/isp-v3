    ...
    <div class="min-h-screen bg-gray-50 py-6 sm:py-8 lg:py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 sm:mb-8">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Tambah Shift Baru</h1>
                <p class="mt-2 text-sm text-gray-600">Isi informasi berikut untuk menambahkan shift kerja baru</p>
            </div>
                                    ...
                                    @foreach ($days as $value => $day)
                                        <label
                                            ...
                                            <input type="checkbox" name="days[]" value="{{ $value }}"
                                                {{ is_array(old('days')) && in_array($value, old('days')) ? 'checked' : '' }}
                                                class="sr-only peer">
