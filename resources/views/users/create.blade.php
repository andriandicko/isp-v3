            ...
            <div class="mb-6">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-0.5">Lengkapi form di bawah untuk menambah user</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                <p class="text-sm text-gray-600 mb-3">Pilih role yang sesuai untuk user ini</p>
                        ...
                        <div>
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    @else
                                        <p class="mt-1.5 text-xs text-gray-500">Password harus minimal 8 karakter</p>
                                    @enderror
                                </div>
            ...
            <div class="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="mt-1 text-sm text-blue-700">Field yang bertanda <span class="text-red-600">*</span>
                            wajib diisi. User akan menerima email notifikasi setelah akun berhasil dibuat.</p>
                    </div>
                </div>
            </div>
        </div>
