        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0 h-12 w-12 bg-blue-100 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                    </div>
                    <div class="ml-4">
                        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Tambah Office Baru</h2>
                        <p class="text-sm text-gray-600 mt-1">Lengkapi informasi office dan tentukan lokasi di peta</p>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('offices.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="p-4 sm:p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                class="w-full px-4 py-2.5 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 transition-all @error('name') border-red-500 ring-2 ring-red-200 @enderror"
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="3"
                                class="w-full px-4 py-2.5 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 transition-all @error('address') border-red-500 ring-2 ring-red-200 @enderror"
                                placeholder="Jl. Sudirman No. 123, Jakarta Pusat" required>{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-2 text-sm text-red-600 flex items-start">
                                    <svg class="w-4 h-4 mr-1 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 flex-1">
                                    <p class="text-sm font-semibold text-blue-900 mb-2">Cara Menentukan Lokasi:</p>
                                    <ul class="text-sm text-blue-800 space-y-1.5">
                                        <li class="flex items-start">
                                            <span class="text-blue-600 mr-2">•</span>
                                            <span><strong>Klik pada peta</strong> untuk menandai lokasi office</span>
                                        </li>
                                        <li class="flex items-start">
                                            <span class="text-blue-600 mr-2">•</span>
                                            <span><strong>Geser marker</strong> untuk menyesuaikan posisi</span>
                                        </li>
                                        <li class="flex items-start">
                                            <span class="text-blue-600 mr-2">•</span>
                                            <span><strong>Gunakan tombol</strong> "Deteksi Lokasi Saya" untuk
                                                auto-detect</span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                <button type="button" onclick="detectMyLocation()"
                                    class="inline-flex items-center justify-center px-4 py-2.5 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all shadow-sm">
                                ...
                                <div class="flex-1 flex gap-2">
                                    <input type="text" id="searchLocation" placeholder="Cari lokasi..."
                                        class="flex-1 px-4 py-2.5 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 text-sm transition-all"
                                        onkeypress="if(event.key === 'Enter') { event.preventDefault(); searchLocation(); }">
                                    <button type="button" onclick="searchLocation()"
                                        class="inline-flex items-center px-4 py-2.5 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all shadow-sm">
                            ...
                            <div class="relative">
                                ...
                                <div id="mapLoading"
                                    ...
                                    <div class="text-center">
                                        <svg class="w-8 h-8 animate-spin text-blue-600 mx-auto" fill="none"
                            ...
                            <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                <div class="flex items-center text-sm">
                                    ...
                                    <span class="text-gray-600 font-medium">Koordinat:</span>
                                    <span id="coordinatesDisplay" class="ml-2 font-mono font-semibold text-gray-900">Klik
                                        peta untuk memilih
                                        lokasi</span>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-4 sm:p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="radius" id="radius" value="{{ old('radius', 200) }}"
                                    min="10" max="5000"
                                    class="w-full px-4 py-2.5 pr-16 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 transition-all @error('radius') border-red-500 ring-2 ring-red-200 @enderror"
                            ...
                            <label class="flex items-start cursor-pointer">
                                <div class="flex items-center h-6">
                                    <input type="checkbox" name="is_active" value="1" checked
                                        class="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500 focus:ring-2 focus:ring-opacity-20 transition-all cursor-pointer">
                                </div>
                                <div class="ml-3">
                ...
                <div
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all shadow-sm">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
